...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_aboutme) {
            ...
            Intent intaboutme = new Intent(MainActivity.this, AboutMe.class);
            startActivity(intaboutme);
        } else if (id == R.id.nav_view_allbook) {
            Intent allbooks = new Intent(MainActivity.this, ViewAllBooks.class);
            startActivity(allbooks);

        } else if (id == R.id.nav_cretebook) {
            Intent createbookintent = new Intent(MainActivity.this, CreteBook.class);
            startActivity(createbookintent);

        } else if (id == R.id.nav_ownbook) {
            Intent ownbookintent = new Intent(MainActivity.this, OwnBook.class);
            startActivity(ownbookintent);
